...
class ReActAgent:
    ...
    def run(self, question: str):
        ...
        while current_step < self.max_steps:
            ...
            if action.startswith("Finish"):
                ...
                # if not final_answer:
                #     # print("警告:未能解析出有效的 finish, 流程中止 ")
                #     print(f"警告：无法解析标准格式，使用原始响应: {action[:100]}...")
                #     return action
    ...
    # 自己新增内容, finish 换行,无法解析    
    def _parse_finish(self, action_text:  str):
        """解析 Finish 字符串,提取最终输出内容"""
